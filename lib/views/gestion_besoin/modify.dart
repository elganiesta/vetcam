...
class ModifyBesoin extends StatefulWidget {
  const ModifyBesoin({Key? key, required this.besoin}) : super(key: key);

  final BesoinModel besoin;
  @override
  State<ModifyBesoin> createState() => _ModifyBesoinState();
}

class _ModifyBesoinState extends State<ModifyBesoin> {
  ...
  Future<void> modifyBesoin() async {
    _besoin
